...
{
    // Заметим, что если знаменатели имеют общий делитель, то сумму дробей a/b + c/d = (a*d + c*b) / (b * d) можно записать, как:
    ...
    //std::cout<<denominator.getStrReference()<<std::endl;
    ...
    //std::cout<<numinator.getStrReference()<<std::endl;
